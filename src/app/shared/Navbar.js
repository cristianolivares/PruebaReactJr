  ...
  render () { 
    return (
      <nav className="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
        ...
        <a className="navbar-brand brand-logo-mini align-self-center d-lg-none" href="!#" onClick={evt =>evt.preventDefault()}><img src={require("../../assets/images/faces/cris.jpg")} alt="logo" /></a>
          ...
          <ul className="navbar-nav navbar-nav-left header-links">         
            <li className="nav-item active d-none d-xl-flex">
              <a href="!#" onClick={evt =>evt.preventDefault()} className="nav-link">
                <i className="mdi mdi-elevation-rise"></i>Reportes</a>
            </li>
            ...
            <li className="nav-item  nav-profile border-0">
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link count-indicator bg-transparent">
                  <span className="profile-text">Cristian Olivares</span>
                  <img className="img-xs rounded-circle" src={require("../../assets/images/faces/cris.jpg")} alt="Profile" />
                </Dropdown.Toggle>
